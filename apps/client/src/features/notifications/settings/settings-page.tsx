...
import { useNotificationPlugins } from "./use-notification-plugins";
import { useRenameChannel } from "./use-rename-channel";
import { useSubscriptions } from "./use-subscriptions";
import { useTestChannel } from "./use-test-channel";
import { useToggleSubscription } from "./use-toggle-subscription";
import type { ChannelRowData, NotificationPluginEntry, NotifCategory } from "./types";
      ...
      <div className="flex flex-col gap-7">
        ...
        <SettingsCard>
          ...
          <Suspense fallback={<SettingsSkeleton />}>
            <NotificationsPage addOpen={addOpen} setAddOpen={setAddOpen} />
          </Suspense>
        </SettingsCard>
      </div>
    </NotificationsErrorBoundary>
