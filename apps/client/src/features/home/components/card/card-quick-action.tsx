...
export function CardQuickAction({ item, isInWatchlist, onToggle }: Props) {
  ...
  return (
    <button
      ...
      className="absolute end-2 bottom-2 z-30 inline-flex size-8 items-center justify-center rounded-full border border-white/20 bg-black/60 text-white opacity-0 backdrop-blur-md transition-all duration-200 hover:bg-black/85 group-focus-within:opacity-100 group-hover:opacity-100"
    >
