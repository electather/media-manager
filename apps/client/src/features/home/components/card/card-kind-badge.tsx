...
export function CardKindBadge({ item }: { item: HomeMediaItem }) {
  ...
  return (
    <span
      title={label}
      aria-label={label}
      className="pointer-events-none absolute end-2 top-2 inline-flex size-6 items-center justify-center rounded-md bg-background/70 text-foreground backdrop-blur-md"
    >
