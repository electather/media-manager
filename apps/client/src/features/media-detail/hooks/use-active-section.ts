...
// bounding-rect reads, not IntersectionObserver: IO skips trigger on instant scrolls
// and misses crossings while intersecting — switching back to IO re-introduces both.
