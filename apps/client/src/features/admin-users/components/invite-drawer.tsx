...
import { CheckCircle2Icon, InfoIcon, PlusIcon } from "lucide-react";
    ...
    <div className="flex h-full flex-col">
          ...
          {generatedUrl ? (
            ...
            <>
              <div className="grid grid-cols-2 gap-3">
                ...
                <ExpiresField value={expiresInDays} onChange={setExpiresInDays} />
              </div>
              <Field>
      ...
      <SheetFooter className="border-t border-border">
        <Button variant="outline" onClick={onClose}>
          {generatedUrl ? m.admin_users_invite_done() : m.admin_users_invite_cancel()}
        </Button>
        {!generatedUrl ? (
    ...
    <div className="flex flex-col gap-4">
      ...
      <Field>
        ...
        <div className="flex items-center gap-2">
          <Input ref={inputRef} readOnly value={url} className="font-mono text-xs" />
