...
// Nightly metadata refresh: reads up to BATCH_LIMIT stale canonical_metadata rows, batches them as BATCH_SIZE chunks against metadata@v1 provider, writes back via CatalogService.writeMetadata.
