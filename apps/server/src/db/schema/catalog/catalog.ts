...
/**
 * Items shape: `{ tmdbId, mediaType, matchReason, topContributors, score }`.
 * `topContributors` added with home-feed backend (feature-home-page-backend-1.md
 * PR2) for typed `MatchReason` chips. Pre-stable rows read back with `[]`.
 */
