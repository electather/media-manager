 ...
 * Foreign keys NOT set here: libSQL already enables them per-connection by default.
 * Locked by regression test in `api/procedures/__tests__/invites.test.ts` (#852 M1).
 */
