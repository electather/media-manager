 ...
 * so it must require BOTH `isSystem === 1` AND `name === SYSTEM_ADMIN_ROLE_NAME` — either
 * condition alone is immediate privilege escalation. Catches isSystem-only, name-only, or ungated `true`.
 */
