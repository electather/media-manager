...
- 3760b39: Capped retry-after delay to 1 hour to prevent arbitrarily long delivery backlogs from a crafted or misbehaving upstream response.
...
- 6cc984c: Added the Discord notification provider so you can receive alerts on Discord.
