...
/** Hono middleware that catches thrown errors, converts HttpError into a structured
 *  JSON body, and captures anything 5xx into the error store. Expected 4xx (bad input,
 *  auth, not-found) is user-product behavior and is never captured. */
