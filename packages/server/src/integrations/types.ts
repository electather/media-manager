...
export interface DownloadProvider {
  ...
  createRequest(tmdbId: string, mediaType: 'movie' | 'tv', seasons?: string): Promise<RequestResult>
...
export type AvailabilityStatus = 'available' | 'requested' | 'processing' | 'unavailable' | 'unknown'
