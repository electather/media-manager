...
| T46 | .      | Wire real RPC for media-details — replace `mock-data.ts` w/ `discover.details` / `home.*` queries; replace `features/requests/` stubs w/ live request flow. Notes/votes mutations hit `preferences.feedback`. | T43,I.api |
